...
/*
 Below we have the constructor Animal.  The eat method is using the "this" keyword.  Use the "new" keyword to assign context to "this", and save the instance to a variable named animal.  You can pass anything you want in for name, species and food.
*/
...
//Code Here
const animal1 = new Animal("Simba", "lion", "Sheep");
// console.log(animal1);
